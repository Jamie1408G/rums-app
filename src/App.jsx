...
export default function RUMS() {
  ...
  async function enableDeviceNotifications() {
    ...
    try {
      ...
      if (!subscription) subscription = await registration.pushManager.subscribe({ userVisibleOnly: true, applicationServerKey: pushKeyBytes(pushPublicKey) });
      ...
      setPushEnabled(true);
      setPushStatus('This device will receive chat and Plaza+ notifications, even when the site is closed.');
